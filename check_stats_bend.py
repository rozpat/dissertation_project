...
def append_features_to_csv(subject, acc_features_list, gyr_features_list, filename):
    ...
    try:
        ...
        # Drop 'CoP' column without modifying the original DataFrames
        acc_df_no_cop = acc_df.drop('CoP', axis=1)
        gyr_df_no_cop = gyr_df.drop('CoP', axis=1)
        cop = acc_df['CoP']

        # Concatenate the DataFrames horizontally
        features_df = pd.concat([acc_df_no_cop, gyr_df_no_cop, cop], axis=1)
